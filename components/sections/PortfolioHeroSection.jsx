...
export default function PortfolioHeroSection() {
  return (
    <section className="relative w-full pt-36 pb-10 bg-[#0A0D14] overflow-hidden text-center">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center gap-3">
        ...
        >
          Audited customer acquisition results, data server tracking integrations, and direct profit matrices mapped across key DTC sectors.
        </motion.p>
